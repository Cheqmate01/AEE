  ...
  <div id="footer" class="flex flex-col bg-black text-white px-10 py-6">
    <div class="flex flex-col langar-regular items-start gap-4">
      ...
      <ul class="flex flex-row items-center my-4 space-x-4">
        <li>
          <a href="https://www.instagram.com/giantsofafrica/" title="Follow on Insragram" target="_blank">
            <svg class="hover:text-yellow-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" x="0" y="0" width="36" height="36" fill="currentColor">
        ...
        <li>
          <a href="https://www.facebook.com/giantsofafrica/" title="Follow on Facebook" target="_blank">
            <svg class="hover:text-yellow-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 36" x="0" y="0" width="18" height="36" fill="currentColor">
        ...
        <li>
          <a href="https://twitter.com/GiantsOfAfrica" title="Follow on X / Twitter" target="_blank">
            <svg class="hover:text-yellow-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 36" x="0" y="0" width="37" height="36" fill="currentColor">
        ...
        <li>
          <a href="https://www.linkedin.com/company/giants-of-africa" title="Follow on LinkedIn" target="_blank">
            <svg class="hover:text-yellow-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 36" x="0" y="0" width="32" height="36" fill="currentColor">
              <path d="M7.59,12.55H1.28L1.19,34.12l7.13-.38V14.93Z"/><path d="M23.45,12.06l-5.39,2.26-.63-1.77-6.25-.49-.33,1.14.34,20.38,7.11-.3-.38-.73L17.43,20l4.06-1.55,2.57,2.39.13,2.35-.51,8.22,2.12,2.11,6-.23L31.31,22,29.82,13.2Z"/><polygon points="6.59 2.82 3.47 2.51 1.24 4.34 0.8 8.55 2.21 10.2 4.78 11.06 8.7 8.36 7.96 4.89 6.59 2.82"/>
            </svg>
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/channel/UCQf4-VGQGaWwmy4qOiHc_gg" title="Follow on Youtube" target="_blank">
            <svg class="hover:text-yellow-500 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 36" x="0" y="0" width="41" height="36" fill="currentColor">
