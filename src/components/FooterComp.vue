      ...
      <ul class="flex flex-row items-center my-4 space-x-4">
        ...
        <li>
          <a title="Follow on LinkedIn" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 32 36" x="0" y="0" width="32" height="36" fill="currentColor">
