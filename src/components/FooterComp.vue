  ...
  <div id="footer" class="flex flex-col bg-black text-white p-5 sm:px-10 py-6">
    <div class="flex flex-col langar-regular items-start gap-4">
      ...
      <ul class="flex flex-row items-center my-4 space-x-4">
        <li>
          <a title="Follow on Insragram" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" x="0" y="0" width="36" height="36" fill="currentColor">
        ...
        <li>
          <a title="Follow on Facebook" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 36" x="0" y="0" width="18" height="36" fill="currentColor">
        ...
        <li>
          <a title="Follow on X / Twitter" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 36" x="0" y="0" width="37" height="36" fill="currentColor">
        ...
        <li>
          <a title="Follow on LinkedIn" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 36" x="0" y="0" width="32" height="36" fill="currentColor">
        ...
        <li>
          <a title="Follow on Youtube" target="_blank">
            <svg class="hover:text-yellow-500 active:text-yellow-300 text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 36" x="0" y="0" width="41" height="36" fill="currentColor">
