<template>
  <div class="space-y-10">
    ...
    <div class="bg-yellow-500 text-black">
      <img class="w-full" src="/head-image.jpg" alt="">
      <a class="langar-regular text-3xl py-10 ml-4 hover:text-gray-800 gap-hover active:text-yellow-300 transition-colors duration-300" href="/community-engagement">
