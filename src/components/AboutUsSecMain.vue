    ...
    <div class="mx-10 py-10">
      ...
      <div>
        ...
        <div class="grid grid-flow-row grid-rows-3 grid-cols-3 gap-1 mt-10 auto-rows-fr items-end justify-center custom-rows">
          ...
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-10 row-start-3 col-start-2" src="/founder-pic-7.jpg" alt="">
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-10" src="/founder-pic-8.jpg" alt="">
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-10" src="/founder-pic-9.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
