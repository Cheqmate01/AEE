    ...
    <div class="mx-10 py-10">
      ...
      <div class="mb-20 h-fit">
        ...
        <p>The premise of Ajayi Elebire Elite was founded on the memory and life of Olalekan Ajayi's father, Babatunde
          ...
          veteran of the Biafra War. Lekan's father would always say this proverb to him, "ronti OMO Eni ti iwonshe ooo,
          nitoripe Eni ti koni Eni to ma de ko kin sinwi oooo" meaning always remember the son of whom you are and that
        ...
        <div class="grid grid-flow-col grid-rows-2 grid-cols-3 gap-1 mt-10 auto-rows-fr items-end justify-center">
          <img class="object-cover w-full aspect-square rounded-lg" src="/father-pic-2.jpg" alt="">
      ...
      <div>
        ...
        <p>Olalekan Ajayi was born on May 5, 1992, in Shomolu Local Government Lagos, Nigeria. He spent most of his life
          ...
          of Winston Salem, North Carolina. During his four-year attendance at QEA, he accomplished a lot on the court
          and in the classroom, winning the National Christian Championship from 2009 to 2011. Mr. Ajayi became the top
          24 overall on ESPN ranking. He also became the Valedictorian of the graduating class of 2011 at QEA. After
          high school, he attended Collins College and Plato, Texas, where he was ranked top 10 junior college
          basketball player of the nation. After obtaining his associate degree in Public Relations, he became an
          Eastern Michigan University Division 1 Eagle in Ypsilanti, Michigan, becoming a two-time student-athlete of
          the year (Academic All-MAC Accolades), earning his Bachelor of Science in Communication. He also played
          basketball and received his Master's at California State University Northridge. After college, he began his
          professional basketball career overseas, playing for Albacete Basketball Club in Spain, Monestire in Tunisia,
          and Petro Atlético in Angelo. But one of Olalekan Ajayi's most significant accomplishments is playing for his
          country, becoming a player on the Senior Nigerian National team. He was awarded the Bronze medal in 2016 at
          the all-African games in the Congo Brazzaville. Olalekan Ajayi accomplished so much before the age of 30 and
          being a student-athlete gave him that opportunity. Because of this, he decided he wanted to pass the torch to
          provide the younger generation with a chance to better their life through his non-profit Ajayi Elebire Elites,
          his mentors Godwin Owinje and Masai Ujiri gave to him and others. His mission is to help change the narratives
        ...
        <div class="grid grid-flow-row grid-rows-3 grid-cols-3 gap-1 mt-10 auto-rows-fr items-end justify-center custom-rows">
          <img class="self-start object-cover w-full aspect-square rounded-lg" src="/founder-pic-2.jpg" alt="">
          <img class="self-start object-cover w-full aspect-square rounded-lg row-start-2" src="/founder-pic-3.jpg" alt="">
          ...
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-10 sm:-mt-28 row-start-3 col-start-2" src="/founder-pic-7.jpg" alt="">
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-[107rem] sm:-mt-56" src="/founder-pic-8.jpg" alt="">
          <img class="self-start object-cover w-full aspect-square rounded-lg -mt-10 sm:-mt-28" src="/founder-pic-9.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
